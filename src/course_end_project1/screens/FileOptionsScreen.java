package course_end_project1.screens;
...
public class FileOptionsScreen implements Screen {
    ...
    public void DeleteFile() {
        ...
        System.out.println("You are deleting a file named: " + fileName);
	     ...
	     //TODO: Delete file ( i need to do more work here......src/main/resources)
		Path path = FileSystems.getDefault().getPath("src/directory"+fileName).toAbsolutePath();
		File file = path.toFile();
	      if (file.delete()) {
